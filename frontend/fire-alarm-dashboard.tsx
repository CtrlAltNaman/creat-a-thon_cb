...
function FireAlarmApp() {
  ...
  // If a zone is selected, show its details view
  if (selectedZone) {
    return (
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent className="p-3 pt-0">
                ...
                <Progress 
                  ...
                  className={`h-2 ${temperature > 30 ? "bg-red-500" : temperature > 25 ? "bg-orange-500" : "bg-green-500"}`}
                />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="p-3 pt-0">
                ...
                <Progress 
                  value={smokeLevel}
                  className={`h-2 ${smokeLevel > 50 ? "bg-red-500" : smokeLevel > 25 ? "bg-orange-500" : "bg-green-500"}`}
                />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="p-3 pt-0">
                ...
                <Progress 
                  value={batteryLevel}
                  className={`h-2 ${batteryLevel < 20 ? "bg-red-500" : batteryLevel < 50 ? "bg-orange-500" : "bg-green-500"}`}
                />
              </CardContent>
            </Card>
